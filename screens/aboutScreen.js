    ...
    <SafeAreaView style={{ flex: 1 }}>
      <View
        ...
        <Text
          ...
          Unipedia is an intiative for university students to provide them notes and past papers at
          a single place. The notes and past papers are collected from students and uploaded to
          database which are available in the app. If you find that you have something valueable for
          others then contact us to share that content with others.
        </Text>
      </View>
      <View style={{ flex: 0.2 }}>
        <Text
